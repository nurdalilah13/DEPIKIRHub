      ...
      <View style={styles.menuOverlay}>
        ...
        <View style={styles.sideMenu}>
          ...
          <ScrollView style={styles.menuList}>
            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(admin)/home")}>
              <Ionicons name="home-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Home</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(admin)/announcement")}>
              <Ionicons name="notifications-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Announcement</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(admin)/userManagement")}>
              <Ionicons name="people-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>User Management</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(admin)/communication")}>
                          <Ionicons name="chatbubble-outline" size={22} color="#666" />
                          <Text style={styles.menuItemText}>Communication</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/adminProfile")}>
              <Ionicons name="person-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Profile</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/adminFaq")}>
