      ...
      <View style={styles.menuOverlay}>
        ...
        <View style={styles.sideMenu}>
          ...
          <ScrollView style={styles.menuList}>
            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(staff)/home")}>
              <Ionicons name="home-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Home</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(staff)/event")}>
              <Ionicons name="calendar-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Event</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(staff)/memberList")}>
              <Ionicons name="people-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Member List</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(staff)/communication")}>
              <Ionicons name="chatbubble-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Communication</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/(staff)/attendance")}>
              <Ionicons name="qr-code-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Attendance</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/staffProfile")}>
              <Ionicons name="person-outline" size={22} color="#666" />
              <Text style={styles.menuItemText}>Profile</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.menuItem} onPress={() => handlePress("/staffFaqchat")}>
